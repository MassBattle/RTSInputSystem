 ...
 */
UCLASS()
class RTSINPUTSYSTEM_API URTSCmd_TrainOfficer : public URTSBuiltinCommandButton
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class RTSINPUTSYSTEM_API URTSCmd_TrainMilitia : public URTSBuiltinCommandButton
{
	GENERATED_BODY()
public:
